...
O [Portainer 2.33.0 LTS](https://docs.portainer.io/start/install-ce/server/docker/linux), funciona com dois elementos: o Portainer Server e o Portainer Agent . Ambos os elementos são executados como contêineres leves em um mecanismo Docker. .
